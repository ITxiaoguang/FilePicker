...
class FilePickerBuilder {
    ...
    fun showPic(showPic: Boolean): FilePickerBuilder {
        PickerManager.showPic = showPic
        return this
    }

    fun showVideo(showVideo: Boolean): FilePickerBuilder {
        PickerManager.showVideo = showVideo
        return this
    }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(context, FilePickerConst.PERMISSIONS_FILE_PICKER) != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(context,
                        context.resources.getString(R.string.no_all_auth),
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if (ContextCompat.checkSelfPermission(it,
                    ...
                    Toast.makeText(fragment.context, it
                            .resources
                            .getString(R.string.no_all_auth), Toast.LENGTH_SHORT).show()
                    return
                }
            }
